        ...
        >
          <div className="rounded-3xl glass-strong p-8 shadow-elegant">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              {mode === "signin" ? "Sign in to start your AI interview." : "Get started with HirevAI in seconds."}
            </p>
            ...
            <form onSubmit={handleEmail} className="space-y-4">
              {mode === "signup" && (
                <div className="space-y-1.5">
                  ...
                  <Input id="name" value={fullName} onChange={(e) => setFullName(e.target.value)} required className="rounded-xl" />
                </div>
              )}
              <div className="space-y-1.5">
            ...
            <p className="text-sm text-muted-foreground text-center mt-6">
              {mode === "signin" ? "New to HirevAI?" : "Already have an account?"}{" "}
              <button
